...
class Character(SQLModel, table=True):
    ...
    age_category: Optional[str] = None  # e.g., "child", "teen", "adult", "old"
    tone: Optional[str] = None  # e.g., "deep", "soft", "warm"
    voice_quality: Optional[str] = None  # e.g., "calm", "energetic", "authoritative"
